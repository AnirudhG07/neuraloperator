"""
experimental/fno_variants.py — EFFICIENCY VARIANTS of the reim FNO (tpu/fno_reim_2d.py), for
research only.  The tested/production model stays in fno_reim_2d.py; nothing here is imported by it.
...
try:
    from tpu.fno_reim_2d import (_adam_init, _adam_step, _conv1x1, _dft, _mlp, add_grid,
                                 channel_mlp, conv1x1, fft2_lowmodes, ifft2_real, load_darcy,
                                 mse, rel_l2)
    from tpu.fft_core import ACC, BF, F
except ImportError:
    from fno_reim_2d import (_adam_init, _adam_step, _conv1x1, _dft, _mlp, add_grid,
                             channel_mlp, conv1x1, fft2_lowmodes, ifft2_real, load_darcy,
                             mse, rel_l2)
    from fft_core import ACC, BF, F
