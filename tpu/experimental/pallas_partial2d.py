"""
experimental/pallas_partial2d.py — FUSED FNO block (fft + GEMM + ifft + skip + GELU) as ONE Pallas
...
try:
    from tpu.fft_core import ACC, F, BF
    from tpu.fno_reim_2d import conv1x1, channel_mlp, add_grid
    from tpu.experimental.fno_proper import spectral_2corner
except ImportError:
    from fft_core import ACC, F, BF
    from fno_reim_2d import conv1x1, channel_mlp, add_grid
    from experimental.fno_proper import spectral_2corner
...
# ═══════════════════════════════════════════════════════════════════════════
#  Whole-FNO forwards at each fusion level (same math as fno_proper.forward_proper)
# ═══════════════════════════════════════════════════════════════════════════
def _stack_blocks(P):
    bl = P["blocks"]
